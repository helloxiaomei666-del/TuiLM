...
test("overview page uses V2 status-first structure without dashboard noise", () => {
  ...
  assert.match(overviewWxml, /退休进度/);
  ...
  assert.match(overviewWxml, /安全垫/);
  assert.match(overviewWxml, /净资产/);
  ...
  assert.match(overviewWxml, /progressText/);
  assert.match(overviewWxml, /progressWidth/);
  assert.match(overviewWxml, /cashflowRetirementRateText/);
  assert.match(overviewWxml, /runwayMonthsText/);
  assert.match(overviewWxml, /currentAssetsText/);
